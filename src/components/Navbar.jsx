            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <a href="#home" className="flex items-center gap-3 cursor-pointer">
                        <img
                            src="/favicon.png"
                            alt="Hyper Tech Studios"
                            className="w-10 h-10"
                        />
                        <span className="font-display font-semibold text-xl text-white hidden sm:block">
                            Hyper Tech Studios
                        </span>
                    </a>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <a
                            ...
                            className="px-4 py-2 btn-gradient text-white rounded-lg font-medium transition-all cursor-pointer flex items-center gap-2"
                        >
                    ...
                    <div className="md:hidden mt-4 pb-4 border-t border-white/10 pt-4">
                        <div className="flex flex-col gap-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-4 py-2 btn-gradient text-white rounded-lg font-medium text-center cursor-pointer"
                            >
                                Tham gia Discord
                            </a>
                        </div>
