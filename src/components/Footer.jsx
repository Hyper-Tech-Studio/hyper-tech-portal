            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-4">
                        ...
                        <p className="text-white/60 text-sm">One team – One dream</p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        {socialLinks.map((link) => (
                            <a
                                ...
                                className="w-10 h-10 rounded-lg bg-white/10 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/20 transition-colors cursor-pointer"
                ...
                <div className="mt-12 pt-8 border-t border-white/10 text-center">
                    <p className="text-white/50 text-sm">
                        © {new Date().getFullYear()} Hyper Tech Studios. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
